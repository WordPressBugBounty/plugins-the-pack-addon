...
use ThePackKitThemeBuilder\Modules\ThemeBuilder\Conditions\Condition_Base;
...
class Conditions_Manager {
	...
	private function register_condition( $id, $args = [] ) {
		...
		$class_name = '\\ThePackKitThemeBuilder\\Modules\\ThemeBuilder\\Conditions\\' . $class_name;
	...
	public function get_documents_for_location( $location ) {
        ...
        $theme_templates_ids = apply_filters('thepack-kit/theme_templates_ids', $theme_templates_ids, $location);
