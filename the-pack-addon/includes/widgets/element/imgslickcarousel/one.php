...
$label = thepack_build_html($settings['ttl'], 'h3', 'title');
$desc = thepack_build_html($settings['dsc'], 'p', 'desc');
?>
<div class="tpigbx tbtr style-one">
    <div class="imgwrap tbtr"><?php echo thepack_ft_images($settings['img']['id'],'full');?></div>
    <?php echo wp_kses_post($label.$desc.$btn);?> 
</div>